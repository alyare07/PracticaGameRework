 ...
 * Administra los cuatro estados de la spritesheet de 16x16: - Fila 0: Fuego
 * normal (repetitiva) - Fila 1: Fuego azul (repetitiva) - Fila 2: Humo de
 * extinción (no repetitiva) - Fila 3: Base apagada en frío (estática, 1 frame)
 * 
 * @version 1.0 (Vanilla Java 8)
 */
public class AnimacionesAntorcha {

	// =========================================================================
	// === 1. CONSTANTES DE ESTADO VISUAL
	// =========================================================================
	public static final int ENCENDIDA = 0;
	public static final int APAGADA_HUMO = 1;
	public static final int BASE = 2;
	public static final int TOTAL_ANIMACIONES = 3;
	...
	public AnimacionesAntorcha() {
		final HojaSprite hoja = Globales.GESTOR_TEXTURAS.getHoja(ClaveHoja.ANTORCHA_8X12);
		...
		if (hoja != null) {
			...
			// Fila 1: Humo al apagarse (Frames 8, 9, 10, 11) - No repetitiva (1 ciclo)
			this.animaciones[APAGADA_HUMO] = new Animacion(hoja.recortarRango(4, 4), false, this.TIEMPO_MS_HUMO);

			// Fila 2: Base Apagada en frío (Frame 12) - Estática
			this.animaciones[BASE] = new Animacion(hoja.recortarRango(5, 1), true, this.TIEMPO_MS_BASE);
		}
	}
