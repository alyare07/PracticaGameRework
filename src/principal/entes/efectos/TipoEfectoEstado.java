 ...
 * 
 * @version 1.1 (Vanilla Java 8 - Hypothermia Stacks Update)
 */
public enum TipoEfectoEstado {
	...
	RESISTENCIA("Piel de Piedra", "Aumenta la defensa y absorción de daño.", true, false, new Color(220, 225, 240),
			0.0),
	...
	HIPOTERMIA("Hipotermia", "Entumecimiento y daño por frío progresivo.", false, true, new Color(90, 190, 255), 2.0),
	HIPERTERMIA("Hipertermia", "Golpe de calor (+Consumo de estamina, mareos y deshidratación).", false, true,
			new Color(255, 75, 65), 2.0);
