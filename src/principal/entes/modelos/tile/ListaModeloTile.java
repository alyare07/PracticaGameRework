...
public final class ListaModeloTile {
	...
	static {
		...
		LISTA_MODELOS.put(COD_ASFALTO,
				new ModeloTile(ModeloTile.ESTADO_TRASPASABLE, Textura.TEXTURA_x32_ASFALTO, 0.25));
		...
		LISTA_MODELOS.put(COD_TIERRA_2,
				new ModeloTile(ModeloTile.ESTADO_TRASPASABLE, Textura.TEXTURA_x32_TIERRA_2, 0.2));
		...
		LISTA_MODELOS.put(COD_CESPED_3_NEVADO,
				new ModeloTile(ModeloTile.ESTADO_TRASPASABLE, Textura.TEXTURA_x32_CESPED_3_NEVADO, -0.25));
		{
			final HojaSprite HOJA_TERRENO = new HojaSprite("/imagenes/texturas/textura.png", 32, true);
			final BufferedImage img = new BufferedImage(Textura.getTextura(Textura.TEXTURA_x32_AGUA_1).getWidth() * 3,
					Textura.getTextura(Textura.TEXTURA_x32_AGUA_1).getWidth(), BufferedImage.TYPE_INT_ARGB);
			final Graphics2D g = (Graphics2D) img.getGraphics();
			g.drawImage(Globales.FUNCIONES.TEXTURAS_TOOLS.redimensionar(HOJA_TERRENO.getSprite(9),
					Textura.getTextura(Textura.TEXTURA_x32_AGUA_1).getWidth(),
					Textura.getTextura(Textura.TEXTURA_x32_AGUA_1).getWidth()), 0, 0, null);
			g.drawImage(
					Globales.FUNCIONES.TEXTURAS_TOOLS.redimensionar(HOJA_TERRENO.getSprite(10),
							Textura.getTextura(Textura.TEXTURA_x32_AGUA_1).getWidth(),
							Textura.getTextura(Textura.TEXTURA_x32_AGUA_1).getWidth()),
					Textura.getTextura(Textura.TEXTURA_x32_AGUA_1).getWidth(), 0, null);
			g.drawImage(
					Globales.FUNCIONES.TEXTURAS_TOOLS.redimensionar(HOJA_TERRENO.getSprite(11),
							Textura.getTextura(Textura.TEXTURA_x32_AGUA_1).getWidth(),
							Textura.getTextura(Textura.TEXTURA_x32_AGUA_1).getWidth()),
					Textura.getTextura(Textura.TEXTURA_x32_AGUA_1).getWidth() * 2, 0, null);
			g.dispose();
			final Animacion animacionAgua = new Animacion(
					new HojaSprite(img, Textura.getTextura(Textura.TEXTURA_x32_AGUA_1).getWidth(), true), true, 750);
			final ModeloTile agua = new ModeloTile(ModeloTile.ESTADO_OBSTACULO, animacionAgua, -0.5,
					Textura.TEXTURA_x32_AGUA_1);
