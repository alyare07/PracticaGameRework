		...
		if (this.municion.utilizarMunicion()) {
			if ((direccion == Direccion.OESTE) || (direccion == Direccion.ESTE)) {
				escenario.crearProyectil(new ProyectilBala(this.damage, this.velocidadDisparo, this.penetrante,
						this.alcance, escenario, xOrigen, yOrigen, this.anchoBala, this.altoBala, direccion, causante,
						soloContraJugador));
			} else {
				escenario.crearProyectil(new ProyectilBala(this.damage, this.velocidadDisparo, this.penetrante,
						this.alcance, escenario, xOrigen, yOrigen, this.altoBala, this.anchoBala, direccion, causante,
						soloContraJugador));
			}
