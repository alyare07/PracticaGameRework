...
public abstract class Arrojadizo extends Consumible {
	...
	public Arrojadizo(int x, int y, int cantidad, final int diametroArea, String codModelo) {
		super(x, y, cantidad, codModelo);
		this.DIAMENTRO_DEL_AREA = diametroArea;
	}
	
	public Arrojadizo(int cantidad, final int diametroArea, String codModelo) {
	...
	@Override
	public void consumir(Criatura c) {
	...
	public abstract void arrojar(final int xDestino, final int yDestino, final Direccion direccion, final Mundo escenario, final Criatura causante);
