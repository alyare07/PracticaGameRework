...
public abstract class Arrojadizo extends Consumible{
    ...
    public abstract void arrojar(final int xDestino, final int yDestino, final Direccion direccion, final Mundo escenario, final Criatura causante, final boolean soloContraJugador);
