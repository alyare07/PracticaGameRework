...
public abstract class Granada extends Arrojadizo {
	...
	public Granada(final int x, final int y, final int cantidad, final int diametroArea, final double damage,
	...
	@Override
	public void arrojar(final int xDestino, final int yDestino, final Direccion direccion, final Mundo mundo,
			final Criatura causante) {
		if (mundo != null) {
			mundo.crearProyectil(new ProyectilGranada(xDestino, yDestino, mundo, causante, this));
