...
public abstract class Proyectil extends Ente implements Serializable {
	...
	public Proyectil(final double damage, final double velocidad, final boolean penetrante, final double alcance, final Mundo mundo, final double x, final double y , final int ancho , final int alto, final Direccion direccion, final Ente causante) {
		this.DAMAGE = damage;
	...
	public Rectangle getArea() {
		return new Rectangle(getPosicionXInt(), getPosicionYInt(), this.ancho, this.alto);
	}
	...
	public static Rectangle reformarAreaHorizontalVertical(final double x, final double y, final int ancho, final int alto) {
		Rectangle areaF = new Rectangle((int)x, (int)y, ancho, alto);
