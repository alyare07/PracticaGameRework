...
/**
 * Ventana central y gestor del inventario principal del jugador. Gestiona la
 * visualización de equipo, slots de almacenamiento y delegación de municiones.
 * 
...
//			if (!Globales.CAMARA.isLookAheadHabilitado()) {
//				Globales.CAMARA.setLookAheadHabilitado(true);
//			}
			return;
		}
//		if (Globales.CAMARA.isLookAheadHabilitado()) {
//			Globales.CAMARA.setLookAheadHabilitado(false);
//		}
	...
	// =========================================================================
	// === DELEGACIÓN DE CONSULTAS Y EXTRACCIÓN DE MUNICIÓN (ZERO-GC)
	// =========================================================================

	/**
	 * Cuenta la cantidad acumulada de balas de reserva de un tipo en la mochila del
	 * jugador.
	 *
	 * @param codModeloMunicion Código del consumible de munición.
	 * @return Total de proyectiles disponibles.
	 */
	...
	/**
	 * Extrae y descuenta del inventario la cantidad solicitada de munición para
	 * recargar.
	 *
	 * @param codModeloMunicion Código del consumible de munición.
	 * @param cantidadRequerida Balas necesarias para llenar la recámara.
