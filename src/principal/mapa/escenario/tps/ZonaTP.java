...
public class ZonaTP extends Ente{
	...
	if (this.puertaTP instanceof PuertaArea) {
	    DibujoDebug.dibujarRectanguloRellenoRefCamara(g, this.AREA, new Color(140 / 255, 134f / 255, 230f / 255, 0.43f));
	} else if (this.puertaTP instanceof PuertaZona) {
	    DibujoDebug.dibujarRectanguloRellenoRefCamara(g, this.AREA, new Color(245f / 255, 20f / 255, 243f / 255, 0.43f));
	} else if (this.puertaTP instanceof PuertaMapa) {
	    DibujoDebug.dibujarRectanguloRellenoRefCamara(g, this.AREA, new Color(251f / 255, 20f / 255, 43f / 255, 0.43f));
	}
    }
