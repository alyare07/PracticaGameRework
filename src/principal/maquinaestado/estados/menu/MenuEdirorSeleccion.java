...
public class MenuEdirorSeleccion extends Menu{
	...
	final int ancho = Constantes.FUNCIONES.MEDIDOR_STRING.medirAnchoPixeles(g, this.textoCarga);
	final int alto = Constantes.FUNCIONES.MEDIDOR_STRING.medirAltoPixeles(g, this.textoCarga);
