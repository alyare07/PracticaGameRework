...
public class MenuPartida extends Menu {
	...
	protected void inicializarBotones() {
		...
		final Boton b4 = new Boton("Salir de la Partida", Color.gray, new Rectangle(xBoton, 280, anchoBoton, altoBoton));
		b4.establecerAccion(() -> {
			this.GE.establecerEstadoActual(GestorEstados.NUMERO_ESTADO_MENU);
			this.GE.disposePartida();
			this.accionPostClick();
			// el click se mantiene cierto tiempo por lo que llega al menuprincipal y activa la accion del boton salir de ese menu
		});
