...
import principal.utilidades.funciones.Trayectorias;
import principal.utilidades.listahojasprites.ListaHojaSprites;
...
//	public static final Mapa MAPA = GLOBALES.mapa;
	public static final Jugador JUGADOR = new Jugador(0,0, 16, 16,
			FUNCIONES.CARGADOR_RECURSOS.cargarImagenCompatibleTranslucida("/imagenes/sprites/player_walking_armed.png"));
...
//	public static final String RUTA_TEXTURA = "/imagenes/texturas/textura.png";
	...
	public static boolean isEstadoJuego() {
		...
		if(Main.gp.getGestorEstados().getEstadoActual() instanceof GestorPartida) {
			return ((GestorPartida)Main.gp.getGestorEstados().getEstadoActual()).getEstadoActivo() instanceof GestorJuego;
		}else {
			return false;
		}
	}
	...
	/**
	 * Calcula el valor para una coordena X teniendo en cuenta 
	 * el desplazamiento de la {@link Camara}.
	...
	/**
	 * Calcula el valor para una coordena Y teniendo en cuenta 
	 * el desplazamiento de la {@link Camara}.
