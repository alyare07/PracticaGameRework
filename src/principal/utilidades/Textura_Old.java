...
// ESTE ES EL B
public final class Textura_Old{
    ...
    static {
	final BufferedImage vacio = new BufferedImage(32, 32, BufferedImage.TYPE_INT_RGB);
	DibujoDebug.dibujarRectanguloRelleno((Graphics2D) vacio.getGraphics(), 0, 0, 32, 32, Color.DARK_GRAY);
	vacio.flush();
	final HojaSprite HOJA_TERRENO = new HojaSprite("/imagenes/texturas/textura.png", 32, true);
	...
	final BufferedImage cesped = new BufferedImage(16, 16, BufferedImage.TYPE_INT_ARGB);
	cesped.getGraphics().drawImage(TEXTURAS.get(Textura_Old.TEXTURA_x32_CESPED), 0, 0, 16, 16, 0, 0, 32, 32, null);
	cesped.flush();
    ...
    static {
	final HojaSprite HOJA_ARBOLES = new HojaSprite("/imagenes/texturas/trees.png", 32, false);
    ...
    static {
	final HojaSprite HOJA_ARBOLES_NEVADOS = new HojaSprite("/imagenes/texturas/treesNevado.png", 32, false);
    ...
    static {
	final HojaSprite HOJA_OBJETOS = new HojaSprite("/imagenes/objetos/items.png", 16, false);
    ...
    static {
	final BufferedImage aux = new BufferedImage(16 * 8, 16, BufferedImage.TYPE_INT_ARGB);
	...
	g.dispose();
	final HojaSprite HOJA_GRANADAS = new HojaSprite(aux, 16, false);
    ...
    static {
	final HojaSprite HOJA_OBJETOS = new HojaSprite("/imagenes/objetos/itemsx10.png", 10, false);
    ...
    static {
	final BufferedImage aux = new BufferedImage(10 * 8, 10, BufferedImage.TYPE_INT_ARGB);
	final Graphics2D g = (Graphics2D) aux.getGraphics();
	...
	g.dispose();
	final HojaSprite HOJA_GRANADAS = new HojaSprite(aux, 10, false);
    ...
    static {
	final HojaSprite HOJA_PARTICULAS = new HojaSprite("/imagenes/objetos/sangrex8.png", 8, false);
    ...
    static {
	final BufferedImage auxExplosion100 = Constantes.FUNCIONES.CARGADOR_RECURSOS.cargarImagenCompatibleTranslucida("/imagenes/sprites/explosion.png");
	final BufferedImage imgExplosion50 = new BufferedImage(50 * 10, 50 * 5, BufferedImage.TYPE_INT_ARGB);
    ...
    static {
	final BufferedImage auxCasa116x112 = Constantes.FUNCIONES.CARGADOR_RECURSOS.cargarImagenCompatibleTranslucida("/imagenes/texturas/house/1.png");
	final BufferedImage imgCasa1 = new BufferedImage(64, 64, BufferedImage.TYPE_INT_ARGB);
	...
	final BufferedImage image = new BufferedImage(ancho, alto, BufferedImage.TYPE_INT_ARGB);
    ...
    public static BufferedImage voltearImagenH(final BufferedImage image) {
	final int widthOfImage = image.getWidth();
	final int heightOfImage = image.getHeight();
	final int typeOfImage = image.getType();

	final BufferedImage newImageFromBuffer = new BufferedImage(widthOfImage, heightOfImage, typeOfImage);

	final Graphics2D g = newImageFromBuffer.createGraphics();
    ...
    public static BufferedImage voltearImagenV(final BufferedImage image) {
	final int widthOfImage = image.getWidth();
	final int heightOfImage = image.getHeight();
	final int typeOfImage = image.getType();
	...
	final BufferedImage b2 = new BufferedImage(image.getHeight(), image.getWidth(), BufferedImage.TYPE_INT_ARGB);
	final Graphics2D g2d = (Graphics2D) b2.getGraphics();
	final AffineTransform at = AffineTransform.getRotateInstance(Math.toRadians(270), image.getWidth() / 2, image.getWidth() / 2);
    ...
    public static BufferedImage redimensionar(final BufferedImage img, final int anchoNuevo, final int altoNuevo) {
	final BufferedImage imgNueva = new BufferedImage(anchoNuevo, altoNuevo, img.getType());
    ...
    static {
	final BufferedImage img = new BufferedImage(Textura_Old.getTextura(Textura_Old.TEXTURA_x32_AGUA_1).getWidth(), Textura_Old.getTextura(Textura_Old.TEXTURA_x32_AGUA_1).getWidth() * 2,
		BufferedImage.TYPE_INT_ARGB);
	final Graphics2D g = (Graphics2D) img.getGraphics();
	g.drawImage(Textura_Old.getTextura(Textura_Old.TEXTURA_x32_AGUA_1), 0, 0, null);
	g.drawImage(Textura_Old.getTextura(Textura_Old.TEXTURA_x32_AGUA_1_INV_H), Textura_Old.getTextura(Textura_Old.TEXTURA_x32_AGUA_1).getWidth(), 0, null);
	g.dispose();
	HOJA_AGUA = new HojaSprite(img, Textura_Old.getTextura(Textura_Old.TEXTURA_x32_AGUA_1).getWidth(), true);
    }
