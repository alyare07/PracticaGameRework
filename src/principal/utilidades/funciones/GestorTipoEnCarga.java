...
/**
 * Clase encargada de proporcionar los tipos de entes. Haciendo mas practico
 * definir en los json al importar o exportar.
 */
public class GestorTipoEnCarga{
	...
	this.TIPOS.put(Spawn.class.getName(), "Spawns Jugador");
	// Fin lista
